...
namespace Dyg.Admin.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ParentCategoryId,CreateDate,CreatedBy,PublishDate,IsPublished,UpdateDate,UpdatedBy")] Category category)
        {
            Security.LoginCheck(HttpContext);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,ParentCategoryId,CreateDate,CreatedBy,PublishDate,IsPublished,UpdateDate,UpdatedBy")] Category category)
        {
            Security.LoginCheck(HttpContext);
            if (id != category.Id)
            {
